# Release Notes - OpenL MCP Server v1.0.0
...
- `openl_search_project_files` - Search paths and text-file content across project files
...
3. **Update client configurations**: Follow the [Quick Start](../guides/quick-start.md) for your AI client
...
For complete setup instructions, see the [Quick Start](../guides/quick-start.md).
...
- [Run with Docker](../guides/advanced.md#run-with-docker) - No Node.js, compose demo, or a shared server
- [Usage Examples](../guides/examples.md) - Common workflows
- [Troubleshooting Guide](../guides/troubleshooting.md) - Solutions to common issues
- [Authentication Guide](../guides/advanced.md#authentication) - Security best practices
...
- [Tool Review](../development/tool-review.md) - API analysis
